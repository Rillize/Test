...
void MainWindow::on_pushButton_2_clicked()//сложение
{
    Calc.plus=true;
    Calc.operation=true;
    Calc.comma=false;
...
void MainWindow::on_pushButton_6_clicked()//вычитание
{
    Calc.minus=true;
    Calc.operation=true;
    Calc.comma=false;
...
void MainWindow::on_pushButton_8_clicked()//умножение
{
...
void MainWindow::on_pushButton_4_clicked()//равно
{
    if(Calc.plus)
    {
